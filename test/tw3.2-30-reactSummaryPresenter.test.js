...
describe("TW3.2 React Summary presenter (observer)", function () {
    this.timeout(200000);
    ...
    it("Summary presenter renders view with correct props", async function(){
        doRender();
    ...
    it("Summary presenter updates view with correct props",  async function(){
